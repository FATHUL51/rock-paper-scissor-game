    ...
    if (player=='rock'){
        if (computerTurn=='rock'){
            ...
            <div class=flex>
                ...
                <div><h1>TIE UP</h1><button onclick="location.href='/index.html'" class="replay">REPLAY</button></div>
                <div>
            ...
            <div ><h1 id="lost">YOU LOST</h1><h3 id="against">AGAINST PC</h3><button onclick="location.href='/index.html'" class="playagain">PLAY AGAIN</button></div>
            <div>
                <div class="cspicked">CS PICKED</div>
                <div class="round3">
                    <div class="round2">
            ...
            <div class="flex">
                ...
                <div class=""><h1 id="lost">YOU WIN</h1><h3 id="against">AGAINST PC</h3><button onclick="location.href='/index.html'" class="playagain">PLAY AGAIN</button></div>
        ...
        <div id="ass2">
            ...
            <div class="buttonofrules"><button onclick="cliaskck()" class="buttonofrules2">RULES
            </button></div>
        </div>
        <div >
            <button class="buttonofrules3" onclick="location.href='/ind.html'">NEXT</button>
        </div>
    </div>
            `
        }
        ...
        <div >
            ...
            onclick="location.href='/ind.html' ">NEXT</button>
        </div>
    </div>
            `
        }
